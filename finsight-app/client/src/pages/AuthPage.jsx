...
const AuthPage = () => {
    ...
    // Simple form state (we'll extend later when wiring backend)
    ...
    // Handle ?tab=login or ?tab=signup
    useEffect(() => {
    ...
    // Keep passwordRules in sync with current password
    useEffect(() => {
    ...
    const handleLoginSubmit = async (e) => {
        ...
        try {
            ...
            saveAuth(user, token, loginForm.rememberMe);
    ...
    const handleSignupChange = (e) => {
        ...
        if (id === "signupPhone" && type !== "checkbox") {
            // strip all non-digit characters (including spaces, dashes, etc.)
            let numeric = value.replace(/\D/g, "");

            // simple max length heuristic by country
            let maxDigits = 15; // default
            if (signupForm.countryCode === "+1" || signupForm.countryCode === "+91") {
                maxDigits = 10; // common length for US/India
            }

            newValue = numeric.slice(0, maxDigits);
        }

        // Normalize age: digits only, no negative sign or non-numeric
    ...
    const validateField = (fieldKey, valueOverride) => {
        const value = valueOverride !== undefined ? valueOverride : signupForm[fieldKey];
        let error = "";
    ...
    const handleSignupSubmit = async (e) => {
        ...
        try {
            // Map to backend-friendly keys. We send both `fullName` and `name`
            // so it works even if the API expects one or the other.
            const payload = {
    ...
    return (
        <div className="login-page">
            ...
            <nav className="navbar navbar-light bg-white shadow-sm">
                <div className="container">
                    ...
                    <button
                        ...
                        onClick={goHome}
                    >
                        <i className="fas fa-arrow-left me-2" aria-hidden="true"></i> Back to Home
                    </button>
                </div>
            </nav>
                        ...
                        <div className="col-12 col-md-10 col-lg-8 col-xl-6">
                            ...
                            <div className="card auth-card border-0 shadow-lg">
                                <div className="card-body p-5">
                                    ...
                                    {/* Tabs */}
                                    <ul className="nav nav-tabs nav-fill auth-tabs mb-4" id="authTabs" role="tablist">
                                        <li className="nav-item" role="presentation">
                                            ...
                                            >
                                                <i className="fas fa-sign-in-alt me-2" aria-hidden="true"></i> Login
                                            </button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button
                                    ...
                                    <div className="tab-content" id="authTabContent">
                                        ...
                                        >
                                            <form id="loginForm" className="auth-form" noValidate onSubmit={handleLoginSubmit}>
                                                {/* Login Alert */}
                                                {loginAlert && (
                                                    <div className="alert alert-danger" role="alert" id="loginAlert">
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <div className="input-group">
                                                        ...
                                                        <input
                                                            ...
                                                            required
                                                        />
                                                        {/* We'll wire visibility toggle later if needed */}
                                                    </div>
                                                ...
                                                <div className="form-check mb-4">
                                                    ...
                                                    />
                                                    <label className="form-check-label" htmlFor="acceptLoginTerms">
                                                ...
                                                >
                                                    <i className="fas fa-sign-in-alt me-2" aria-hidden="true"></i> Sign In
                                                </button>
                                        ...
                                        >
                                            ...
                                            >
                                                {/* Signup Alert */}
                                                {signupAlert && (
                                                    <div className="alert alert-danger" role="alert" id="signupAlert">
                                                        <i className="fas fa-exclamation-circle me-2" aria-hidden="true"></i>
                                                ...
                                                {/* Gender */}
                                                <div className="mb-3">
                                                    <label htmlFor="signupGender" className="form-label">
                                                        Gender
                                                    </label>
                                                    <div className="input-group">
                                                        <span className="input-group-text">
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <div className="mt-2">
                                                        ...
                                                        <small
                                                            className={`d-block ${
                                                                passwordRules.length ? "text-success" : "text-muted"
                                                            }`}
                                                        >
                                                        ...
                                                        <small
                                                            className={`d-block ${
                                                                passwordRules.upper ? "text-success" : "text-muted"
                                                            }`}
                                                        >
                                                            {passwordRules.upper ? "✔" : "•"} One uppercase letter (A-Z)
                                                        </small>
                                                        <small
                                                            className={`d-block ${
                                                                passwordRules.lower ? "text-success" : "text-muted"
                                                            }`}
                                                        >
                                                            {passwordRules.lower ? "✔" : "•"} One lowercase letter (a-z)
                                                        </small>
                                                        <small
                                                            className={`d-block ${
                                                                passwordRules.digit ? "text-success" : "text-muted"
                                                            }`}
                                                        >
                                                            {passwordRules.digit ? "✔" : "•"} One number (0-9)
                                                        </small>
                                                        <small
                                                            className={`d-block ${
                                                                passwordRules.special ? "text-success" : "text-muted"
                                                            }`}
                                                        >
                                                ...
                                                <div className="d-flex gap-2 mb-3">
                                                    ...
                                                    >
                                                        <i className="fab fa-facebook-f me-2" aria-hidden="true"></i>{" "}
                                                        Facebook
                                                    </button>
                                                </div>
                                            </form>
            ...
            {/* FORGOT PASSWORD MODAL (React-controlled, not Bootstrap JS) */}
            {showResetModal && (
                <div
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <form id="forgotPasswordForm" noValidate onSubmit={handleResetSubmit}>
                                    <div className="mb-3">
